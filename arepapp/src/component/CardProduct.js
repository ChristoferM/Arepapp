...
function ConfirmationCardProduct({product, handleDetails}){
            ...
            <Card className='my-3 rounded-4' >
                <Card.Body className='d-flex align-items-center'>
                    <div className='w-25 me-3' style={{ display: 'flex'}}>
                        <Image className='h-50 w-100 ' src={product.img} alt={`Imgen de ${product.titulo}`} onClick={handleDetailsClick} rounded/>
                    </div>
                    <div>
                        ...
                        <ButtonGroup className='align-items-center'>
                            ...
                            <span className="mx-3 fw-bolder" style={{ display: 'inline-block', verticalAlign: 'middle' }}>0</span>
                            <Button  className='text-black' style={{backgroundColor: '#FEC151',border:'none'}}>-</Button>
                        </ButtonGroup>
